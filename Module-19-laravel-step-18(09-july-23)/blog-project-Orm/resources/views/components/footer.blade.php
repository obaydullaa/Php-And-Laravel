            ...
            <div class="col-lg-7">
                <div class="subscribe-wrap position-relative">
                    ...
                    <div class="section-heading">
                        ...
                        <p class="section-heading__desc text-white">Data transfer capacity has generally been
                            inconsistent dispersed around the world, with expanding focus in the advanced age just.</p>
                    </div>
...
{{-- <div class="client py-60 ">
    <div class="container">
        <div class="client-logos client-slider">
            ...
            <img src="assets/images/2__brands/client-02.png" alt="">
            <img src="assets/images/2__brands/client-03.png" alt="">
            <img src="assets/images/2__brands/client-04.png" alt="">
            <img src="assets/images/2__brands/client-05.png" alt="">
            <img src="assets/images/2__brands/client-06.png" alt="">
            <img src="assets/images/2__brands/client-03.png" alt="">
        </div>
    </div>
</div> --}}
                ...
                <div class="col-xl-3 col-sm-6">
                    <div class="footer-item">
                        <div class="footer-item__logo">
                            <a href="index.html" class="footer-logo-normal"> <img src="assets/images/logo/logo.png"
                                    alt=""></a>
                            <a href="index.html" class="footer-logo-dark hidden"> <img
                                    src="assets/images/logo/dark-logo.png" alt=""></a>
                        </div>
                        <p class="footer-item__desc mb-3">Let's make something great together. We are trusted by over
                ...
                <div class="col-xl-2 col-sm-6">
                    <div class="footer-item">
                        ...
                        <ul class="footer-menu">
                            ...
                            <li class="footer-menu__item"><a href="food.html" class="footer-menu__link">About Us</a>
                            </li>
                            <li class="footer-menu__item"><a href="sports.html" class="footer-menu__link">Contact Us</a>
                            </li>
                            <li class="footer-menu__item"><a href="sports.html" class="footer-menu__link">Blog</a></li>
                            <li class="footer-menu__item"><a href="sports.html" class="footer-menu__link">Blog
                                    Details</a></li>
                        ...
                        <div class="blog-sidebar">
                            <div class="latest-blog">
                                ...
                                <div class="latest-blog__content">
                                    <h6 class="latest-blog__title"><a href="blog-details.html">Sound Everyday Rutine For
                                            Your amet.</a></h6>
                            ...
                            <div class="latest-blog">
                                ...
                                <div class="latest-blog__content">
                                    <h6 class="latest-blog__title"><a href="blog-details.html">Lorem ipsum dolor sit
                                            amet.</a></h6>
                                    <span class="latest-blog__date">June 23 202</span>
                                </div>
                            </div>
